...
aut aut aut maxime quia temporibus ut omnis`}],Tc=({post:e})=>{const{userId:t,title:i,body:n,id:a}=e,u=Pc.find(r=>r.id===t),o=Lc.filter(r=>r.postId===a);return R.jsxs("div",{className:"PostInfo",children:[R.jsxs("div",{className:"PostInfo__header",children:[R.jsx("h3",{className:"PostInfo__title",children:i}),R.jsxs("p",{children:[" Posted by  ",R.jsx(Nc,{user:u})]})]}),R.jsx("p",{className:"PostInfo__body",children:n}),o.length?R.jsx(zc,{comments:o}):R.jsxs(R.Fragment,{children:[R.jsx("hr",{}),R.jsx("b",{"data-cy":"NoCommentsMessage",children:"No comments yet"})]})]})},Mc=({posts:e})=>R.jsx("div",{className:"PostList",children:e.map(t=>R.jsx(Tc,{post:t},t.id))}),Rc=[{id:1,userId:1,title:"sunt aut facere repellat provident occaecati excepturi optio reprehenderit",body:`quia et suscipit
